...
function App() {
  ...
  useEffect(() => {
    fetch(BASE_URL)
      .then(res => res.json())
      .then(data => {
        let firstCurrency = Object.keys(data.rates)[52]
    ...
    <div className='flex justify-center items-center text-center'>
      <div>
        ...
        <CurrencyRow  
          ...
          onChangeCurrencySelector={e => setFromCurrency(e.target.value)}
        ...
        <CurrencyRow 
          ...
          onChangeCurrencySelector={e => setToCurrency(e.target.value)}
